...
namespace BrightIdeasSoftware
{
    ...
    public class BaseRenderer : AbstractRenderer
    {
        ...
        protected virtual int CalculateCheckBoxWidth(Graphics g) {
            if (!this.ListView.CheckBoxes || !this.ColumnIsPrimary || (this.ListView.CheckBoxHiddenGetter != null && this.ListView.CheckBoxHiddenGetter(this.ListItem.RowObject))) 
                return 0;
        ...
        protected virtual bool IsCheckBoxDisabled {
            get {
                if (this.ListItem != null && (!this.ListItem.Enabled || (this.ListView.CheckBoxDisabledGetter != null && this.ListView.CheckBoxDisabledGetter(this.ListItem.RowObject))))
                    return true;
    ...
    public class CheckStateRenderer : BaseRenderer
    {
        ...
        public override void Render(Graphics g, Rectangle r) {
            ...
            if (this.Column == null || (this.Column.CheckBoxHiddenGetter != null && this.Column.CheckBoxHiddenGetter(this.RowObject)))
                return;
            r = this.ApplyCellPadding(r);
