...
namespace BrightIdeasSoftware {
    ...
    /// <summary>
    /// These delegates are used to get the disabled state of the checkbox for a row object.
    /// </summary>
    /// <param name="rowObject"></param>
    /// <returns></returns>
    public delegate bool CheckBoxDisabledGetterDelegate(Object rowObject);

    /// <summary>
    /// These delegates are used to get the hidden state of the checkbox for a row object.
    /// </summary>
    /// <param name="rowObject"></param>
    /// <returns></returns>
    public delegate bool CheckBoxHiddenGetterDelegate(Object rowObject);
