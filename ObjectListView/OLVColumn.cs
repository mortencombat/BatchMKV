...
namespace BrightIdeasSoftware {
    ...
    public partial class OLVColumn : ColumnHeader {
        ...
        /// <summary>
        /// This delegate will be used to extract a boolean to decide if any subitem checkbox should be hidden.
        /// </summary>
        /// <remarks>
        /// If this is set, AspectName is ignored.
        /// </remarks>
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public CheckBoxHiddenGetterDelegate CheckBoxHiddenGetter
        {
        ...
        public Object GetImage(object rowObject) {
            if (this.CheckBoxes && (this.checkBoxHiddenGetter == null || !this.checkBoxHiddenGetter(rowObject)))
