...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        /// <summary>
        /// This delegate will be called whenever the ObjectListView needs to know if a checkbox
        /// of the row associated with a given model object should be disabled.
        /// </summary>
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual CheckBoxDisabledGetterDelegate CheckBoxDisabledGetter
        {
            get { return checkBoxDisabledGetter; }
            set { checkBoxDisabledGetter = value; }
        }
        private CheckBoxDisabledGetterDelegate checkBoxDisabledGetter;

        /// <summary>
        /// This delegate will be called whenever the ObjectListView needs to know if a checkbox
        /// of the row associated with a given model object should be hidden.
        /// </summary>
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual CheckBoxHiddenGetterDelegate CheckBoxHiddenGetter
        {
            get { return checkBoxHiddenGetter; }
            set { checkBoxHiddenGetter = value; }
        }
        private CheckBoxHiddenGetterDelegate checkBoxHiddenGetter;
...
//                    break;
        ...
        /// <param name="modelObject"></param>
        /// <returns></returns>
        protected virtual bool GetCheckBoxDisabled(Object modelObject)
        {
            return (this.CheckBoxDisabledGetter != null && this.CheckBoxDisabledGetter(modelObject));
        }
        ...
        protected virtual bool SetObjectCheckedness(object modelObject, CheckState state) {
            ...
            if (this.CheckBoxDisabledGetter != null && this.CheckBoxDisabledGetter(modelObject))
                return false;
